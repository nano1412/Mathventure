...
public class LevelCreatorSetter : MonoBehaviour
{
    ...
    public void SetLevel1Btn()
    {
        ...
        LevelCreator.current.SetLevelCreator(1, false, Level1SpawnableItemsInShop, possibleOperators);
    }
    ...
    public void SetLevel2Btn()
    {
        ...
        LevelCreator.current.SetLevelCreator(2, false, Level2SpawnableItemsInShop, possibleOperators);
    }
    ...
    public void SetLevel3Btn()
    {
        ...
        LevelCreator.current.SetLevelCreator(3, false, Level3SpawnableItemsInShop, possibleOperators);
    }
    ...
    public void SetLevel4Btn()
    {
        ...
        LevelCreator.current.SetLevelCreator(4, false, Level4SpawnableItemsInShop, possibleOperators);
    }
    ...
    public void SetLevelEndlessBtn()
    {
        ...
        LevelCreator.current.SetLevelCreator(5, true, LevelEndlessSpawnableItemsInShop, possibleOperators);
    }
}
